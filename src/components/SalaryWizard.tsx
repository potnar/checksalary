              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-white border border-slate-200 rounded-lg py-4 px-4 text-slate-900 font-medium focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none transition-all placeholder:text-slate-300"
